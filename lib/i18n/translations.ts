...
export const translations = {
  en: {
    meta: {
      ...
      description:
        "Figure out what someone actually meant. AI-powered communication decoder.",
      ogTitle: "Unspoken",
      ogDescription: "Finally understand what they really meant.",
    },
    header: {
      badge: "Reading Between the Lines",
      tagline: "Type what they said. Find out what they really meant.",
    },
    footer: {
    ...
    input: {
      ...
      ariaLabel: "Describe what they said or did",
      submit: "Decode It",
    ...
    chat: {
      ...
      emptySubtitle:
        "Tell Unspoken what someone said or did to start a new chat.",
  ...
  id: {
    meta: {
      ...
      description:
        "Cari tahu apa yang sebenarnya dimaksud seseorang. Dekoder komunikasi berbasis AI.",
      ogTitle: "Unspoken",
      ogDescription: "Akhirnya paham apa yang sebenarnya dimaksud.",
    },
    header: {
      badge: "Baca Maksud Tersirat",
      tagline: "Ketik apa yang seseorang bilang. Kita cari tahu maksud sebenarnya.",
    },
    footer: {
      privacy:
    ...
    input: {
      label: "Orangnya bilang atau ngelakuin apa?",
      placeholder:
        'mis. "Terserah kamu aja deh" waktu aku tanya rencana akhir pekan...',
      ariaLabel: "Ceritain apa yang orang itu bilang atau lakuin",
    ...
    categories: {
      title: "Ini situasi hubungan apa?",
      options: {
        partner: "Pasangan",
        dating: "Dating",
        family: "Keluarga",
    ...
    streaming: {
      ...
      phase: {
        ...
        identifying: "Cari tahu apa yang orang itu butuhin...",
    ...
    errors: {
      ...
      emptyInput: "Ceritain dulu dong apa yang orang itu bilang atau lakuin!",
    ...
    chat: {
      ...
      emptySubtitle:
        "Ceritain ke Unspoken apa yang seseorang bilang atau lakuin untuk memulai obrolan baru.",
